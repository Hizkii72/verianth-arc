  ...
  return (
    <div className="space-y-6" data-testid="personal-page">
      <div className="flex items-start justify-between flex-wrap gap-3">
        <div>
          <h1 className="font-heading text-2xl sm:text-3xl font-bold tracking-tight">{t("per.title")}</h1>
          <p className="text-sm text-muted-foreground">{t("per.sub")}</p>
        </div>
